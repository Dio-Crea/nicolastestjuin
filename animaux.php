...
$select_query = mysqli_query($mysqli, "SELECT * FROM rubriques where id=1  ");
...
$nb_total = mysqli_query($mysqli,"SELECT COUNT(*) AS nb_total FROM photo_has_rubriques where rubriques_id=1");
